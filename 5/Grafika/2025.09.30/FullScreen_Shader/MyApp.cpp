...
void CMyApp::Render()
{
	...
	if (m_ScreenX > m_ScreenY) {
		glUniform1f(glGetUniformLocation(m_programID, "ScreenRatioX"), m_ScreenX / m_ScreenY);
		glUniform1f(glGetUniformLocation(m_programID, "ScreenRatioY"), 1);
	}
	else {
		glUniform1f(glGetUniformLocation(m_programID, "ScreenRatioX"), 1);
		glUniform1f(glGetUniformLocation(m_programID, "ScreenRatioY"), m_ScreenY / m_ScreenX);
	}
