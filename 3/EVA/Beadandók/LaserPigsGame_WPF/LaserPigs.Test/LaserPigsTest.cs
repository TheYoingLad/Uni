...
namespace LaserPigs.Test
{
    ...
    public class LaserPigsTest
    {
        ...
        public async Task TestLoadGameInvalidMapSize()
        {
            ...
            _fileManagerMock.Setup(mock => mock.LoadAsync("")).Returns(() => Task.FromResult((_mockP1, _mockP2, 0)));
            await Assert.ThrowsExceptionAsync<ArgumentException>(() => _model.LoadGameAsync(""));

            _fileManagerMock.Verify(fm => fm.LoadAsync(""), Times.Once);
        }
        [TestMethod]
        ...
        {
            _fileManagerMock.Setup(mock => mock.LoadAsync("")).Returns(() => Task.FromResult((_mockP1, _mockP2, 2)));
            await Assert.ThrowsExceptionAsync<ArgumentException>(() => _model.LoadGameAsync(""));

            _fileManagerMock.Setup(mock => mock.LoadAsync("")).Returns(() => Task.FromResult((_mockP1, _mockP2, -1)));
            await Assert.ThrowsExceptionAsync<ArgumentException>(() => _model.LoadGameAsync(""));

            _fileManagerMock.Setup(mock => mock.LoadAsync("")).Returns(() => Task.FromResult((_mockP1, _mockP2, 6)));
            await Assert.ThrowsExceptionAsync<ArgumentException>(() => _model.LoadGameAsync(""));

            _fileManagerMock.Verify(fm => fm.LoadAsync(""), Times.Exactly(3));
        }
        [TestMethod]
        ...
        public void TestNextAllDone()
        {
            FillP1();
            FillP2();
            _fileManagerMock.Setup(mock => mock.LoadAsync("")).Returns(() => Task.FromResult((_mockP1, _mockP2, 5)));
