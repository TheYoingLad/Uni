...
namespace Snake.Model
{
    public class GameModel : IDisposable
    {
        ...
        public async static Task<GameModel> Create(ITimerService timerService)
        {
            return await Create(null, timerService);
        }

        public async static Task<GameModel> Create(IDataAccess? dataAccess = null, ITimerService? timerService = null)
        {
            GameModel model = new GameModel();
            await model.ReloadModel(dataAccess, timerService, true);
            return model;
        }
        ...
        public async Task ReloadModel(IDataAccess? _dataAccess = null, ITimerService? _timerService = null, bool clear = false)
        {
            // timer
            ...
            else (Resolution, walls) = await this.dataAccess!.LoadAsync();
