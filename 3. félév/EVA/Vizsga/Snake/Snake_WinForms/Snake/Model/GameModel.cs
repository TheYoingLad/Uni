...
namespace Snake.Model
{
    ...
    */
    ...
    public class GameModel : IDisposable
    {
        ...
        public virtual List<Coordinate> EggPoses { get { return new List<Coordinate>(eggPoses); } }
        ...
        private readonly IDataAccess? dataAccess = null;

        private readonly List<Coordinate> walls = new List<Coordinate>();
        ...
        {   
            ...
            timer = new TimerService(new TimerCallback(TimerTick!));

            ResetGame();
        }

        public GameModel(ITimerService timerService) : base()
        {
            Resolution = 15;
            walls = new List<Coordinate>();
        ...
        public GameModel(IDataAccess dataAccess)
        {
            ...
            (Resolution, walls) = this.dataAccess.Load();
        ...
        public GameModel(ITimerService timerService, IDataAccess dataAccess)
        {
            timer = timerService;
            timerService.Tick += TimerTick!;
        ...
        /// <summary>
        /// Needed to implement IDisposable inorder to dispose Timer safely
        /// </summary>
        public void Dispose()
        {
