...
namespace Snake.Tests
{
    ...
    public class GameModelTests : IDisposable
    {
        ...
        private readonly TesterTimer timer;

        public GameModelTests()
        {
            timer = new TesterTimer();
            game = new GameModel(timer);
        }
        ...
        public void IncreaseScoreTest()
        {
            ...
            Mock<GameModel> mockedGame = new Mock<GameModel>(manualTimer) { CallBase = true};
        ...
        [TestMethod]
        public void SaturatedMapTest()
        {
            TesterTimer manualTimer = new TesterTimer();
            IDataAccess dataAccess = new SaveFileDataAccess("test.save");
            GameModel test = new GameModel(dataAccess, manualTimer);
        ...
        public void WrongFormatTest()
        {
            ...
            Assert.ThrowsException<FormatException>(new Action(() =>
            {
                GameModel test = new GameModel(dataAccess);
                test?.Dispose();
            }));
        }
