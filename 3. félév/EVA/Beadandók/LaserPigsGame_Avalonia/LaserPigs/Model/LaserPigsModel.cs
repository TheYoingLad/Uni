...
{
    /// <summary>
    /// The enumeration for game phases
    /// </summary>
    public enum Phase { P1, P2, Fight }
    /// <summary>
    /// The model for the Laser Pigs game
    /// </summary>
    public class LaserPigsModel
    {
        ...
        {
            (Player p1, Player p2, int instructionIndex) = await _fileManager.LoadAsync(stream);
        ...
        {
            (Player p1, Player p2, int instructionIndex) = await _fileManager.LoadAsync(path);
        ...
        {
            await _fileManager.SaveAsync(stream, _p1, _p2, _instructionIndex);
        }
        /// <summary>
        /// Saves the game to a file
        /// </summary>
        ...
        {
            await _fileManager.SaveAsync(path, _p1, _p2, _instructionIndex);
        }
        /// <summary>
        ...
        private void ProcessParralel(Instruction ins1, Instruction ins2)
        {
            if (ins1 is Step step1 && ins2 is Step step2)
            {
                ...
                if (tempCoord1 != tempCoord2 && !(tempCoord1 == startCoord2 && tempCoord2 == startCoord1))
                {
