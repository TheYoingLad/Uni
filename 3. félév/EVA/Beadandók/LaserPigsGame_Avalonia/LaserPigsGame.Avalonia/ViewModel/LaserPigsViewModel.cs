...
namespace LaserPigsGame.Avalonia.ViewModel
{
    ...
    public class LaserPigsViewModel : ViewModelBase
    {
        ...
        /// </summary>
        public IImmutableBrush P1Colour
        {
            get
            {
                return Brushes.Blue;
        ...
        /// </summary>
        public IImmutableBrush P2Colour
        {
            get
            {
                return Brushes.Red;
        ...
        /// </summary>
        public IImmutableBrush P1HpColour
        {
            get
            {
        ...
        /// </summary>
        public IImmutableBrush P2HpColour
        {
            get
            {
        ...
        private void Model_PlayerStep(object? sender, StepEventArgs e)
        {
            ...
            IImmutableBrush playerColour = startCell.TextColour;
